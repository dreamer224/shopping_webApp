...
public final class product_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  try{     
   ...
   // String strQuery = "select * from items where type= stationary'";
    ...
    while(rs.next()){
      ...
      out.write("\">A Girl That Had<br> to be Strong</a>\n");
      out.write("</div>\n");
      out.write("\n");
      ...
      out.print(rs.getString(1));
      out.write("\" width=\"250\" height=\"310\"  class=\"image1 card\">\n");
      out.write("\t</div>\n");
      out.write("\t<div class=\"column1 right\"\n");
      out.write("\tstyle=\"background-color:white;\">\n");
      out.write("            <div class=\"columns\"><b>DETAILS</b></div>\n");
      out.write("            <p>");
      out.print(rs.getString("details"));
      out.write("</p>\n");
      out.write("        \n");
      out.write("            <h5 class=\"h5\">Rs.");
  ...
  catch(Exception e)
  {
    e.getMessage();
      ...
      out.write("\t<tr><td><p><button class=\"button card\"><b>Add To Cart</b></button></p></td></tr></table>\n");
      out.write("\t</div>\n");
      out.write("</div>\n");
      out.write("</body></html>");
    } catch (Throwable t) {
