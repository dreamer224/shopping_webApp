...
public final class fake_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("  <a href=\"bbcpro.html\">HOME</a>\n");
      ...
      out.write("        <button type=\"submit\" name=\"s\" value=\"s\" ></button>\n");
      ...
      out.write("   <p class=\"p5\">Search Result</p>\n");
      out.write("</div>\n");
      out.write("  ");

  try{      
    Class.forName("org.apache.derby.jdbc.ClientDriver").newInstance();
    Connection con=DriverManager.getConnection("jdbc:derby://localhost:1527/BBCpro","daabshop","daabshop");
  ...
  //  String e= "hj";
    ...
    ps.setString(1,"%"+sid+"%");
   // ps.setString(1,sid);
  //  PreparedStatement pst = con.prepareStatement("select * from ITEMS where time = (select max(time) from items order by time (desc) ");
