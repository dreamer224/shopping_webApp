...
public final class delete_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("  <a href=\"stationary.html\">HOME</a>\n");
      out.write("  <a href=\"#\">FEEDBACK</a>\n");
      out.write("  <a href=\"register.html\">SIGNUP</a>\n");
      ...
      out.write("                       \n");
      out.write("                            <p class=\"p5 columns\">DELETE DETAILS</p>\n");
      out.write("                            <br>\n");
      out.write("                            <center>\n");
      out.write("<form name=\"f1\">\n");
      out.write("    <br><br>\n");
      out.write("       <table>\n");
      out.write("           <tr><td>Enter id:</td><td><input type=\"text\" name=\"id\" value=\"\" /></td></tr></table><br>\n");
    ...
    try{
        ...
        if(request.getParameter("done")!=null)
        {
            ...
            //out.println("j");
           // PreparedStatement ps=conn.prepareStatement("delete from ITEMS where id where id=?");
           // out.println("new");
            Statement st=conn.createStatement();
            int x=st.executeUpdate("Delete from items where id='"+id+"'");
      ...
      out.write("<br><br>");
            ...
            if(x>0)
            {
               out.println("ITEMS HAVE BEEN DELETED");
               
               
            }
            
            else
                out.println("Please enter your details carefully");
