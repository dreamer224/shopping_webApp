...
public final class update_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                       \n");
      out.write("                            <p class=\"p5 columns\">UPDATE DETAILS</p>\n");
      out.write("                            <br>\n");
      out.write("                            <center>\n");
      out.write("                            \n");
    ...
    try{
        ...
        if(request.getParameter("done")!=null)
        {
           ...
           // String details=request.getParameter("details");
            ...
            //out.println("1");
            PreparedStatement ps=conn.prepareStatement("UPDATE items " + "SET price = ? " + "WHERE id = ?");
           // out.println("new");
      ...
      out.write("<br><br>");
            ...
            if(x>0)
            {
               out.println("Details have been updated");
               ps.close();
               //fis.close();
            }
