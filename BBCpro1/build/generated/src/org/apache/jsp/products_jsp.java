...
public final class products_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  catch(Exception e)
  {
    e.getMessage();
      ...
      out.write("\t<tr><td><p><button class=\"button card\" type=\"submit\" name=\"cat\"><b>Add To Cart</b></button></p></td>\n");
      out.write("            <td><p><button class=\"button card\" type=\"submit\" name=\"feed\"><b>Feedback</b></button></p></td>\n");
      out.write("        </tr></table>\n");
      out.write("  </form>\n");
      out.write("        </div>\n");
      out.write(" \n");
...
try
    {
        ...
        if(request.getParameter("cat")!=null)
        {
            ...
            int x=0;
            x=st.executeUpdate("insert into cart values('"+session.getAttribute("user")+"','"+session.getAttribute("item_id")+"')");
            if(x>0)
            {
