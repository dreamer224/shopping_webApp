<%-- 
    Document   : delete
    Created on : 11 May, 2020, 8:52:39 AM
    Author     : AMISHA GUPTA
--%>
 ...
 <div class="main">
                <div class="column3">
                    <div class="card">
                            ...
                            <p class="p5 columns">DELETE DETAILS</p>
                            <br>
                            <center>
<form name="f1">
    <br><br>
       <table>
           <tr><td>Enter id:</td><td><input type="text" name="id" value="" /></td></tr></table><br>
    ...
    try{
        ...
        if(request.getParameter("done")!=null)
        {
          ...
          //  int x=ps.executeUpdate();
            ...
            if(x>0)
            {
               out.println("ITEM HAVE BEEN DELETED");
