<%-- 
    ...
    Created on : 11 May, 2020, 4:14:07 PM
    Author     : AMISHA GUPTA
--%>
...
<div class="main">
	<div class="column">
            <center> <h2><p class="p5">CHANGE PASSWORD</p></h2></center>
	<div class="card">
            <center>
                <br>
                <table>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="opw" required> </td>
                    </tr>
                    
                    
                    <tr>
                        <td><b>New Password:</b></td> 
                        <td><input type="text" name="pw1" required> </td>
                    </tr>
                    
                    <tr>
                        <td><b>Confirm Password:</b></td> 
                        <td><input type="text" name="pw2" required> </td>
                    </tr>
                    
                    
                </table>
                <br>
               <button class="button1" name="set" type="submit">Set</button>
            </center>
	</div>
	</div>
</div>
    ...
    try
    {
        if(request.getParameter("set")!=null)
        {
            ...
            if(p1.equals(p2) && p00.equals(p0))
            {
                ...
                if(x>0)
                { %> 
                <center> <p>UPDATED...</p></center>
                    <% }
            }
            else
            {
                %> 
            <center> <p>NOT UPDATED...</p></center>
                <%
            }
        }
